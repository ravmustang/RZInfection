...
private["_itemClassName","_consumingConfig","_configEffects","_feedbackString","_effectAttributeId","_effectValue","_effectDuration","_effectUnit","_effect","_addPlusCharacter","_bloodAlcohol","_bloodAlcoholComment","_animations","_animationIndex","_stopBleeding","_configSounds","_numberOfConfigSounds","_returnItemClass","_rzantivirus","_items","_availMeds","_ppInfInjYes","_ppInfInjNo","_ppInfInjNo2","_ppInfInjNo3","_ppInfInjNo4","_ppInfInjNo5","_ppInfInjNo6","_ppInfInjEnd","_ppInfPillYes","_ppInfPillNo","_ppInfPillNo2","_ppInfPillNo3","_ppInfPillNo4","_ppInfPillEnd"];
	...
	switch (_itemClassName) do 
	{
		case "rzinfection_antivirus_injector": 
		{
			...
			player spawn 
			{
				...
				{
					["SuccessTitleAndText", ["Injector Success", "After just seconds, your infection was cured!"]] call ExileClient_gui_toaster_addTemplateToast;
				...
				{
					["ErrorTitleAndText", ["Attention!", "You injected yourself with a live culture and were not infected, you WILL start to feel sick."]] call ExileClient_gui_toaster_addTemplateToast;
		...
		case "rzinfection_antivirus_pills": 
		{
			...
			player spawn
			{
				...
				["SuccessTitleAndText", ["Popped Antiviral Pills", _feedbackString]] call ExileClient_gui_toaster_addTemplateToast;
				...
				else
				{
					...
					_ppInfPillNo;
					sleep 10;
					["ErrorTitleAndText", ["Attention!", "You just popped antiviral pills and were not infected, you might start to feel sick."]] call ExileClient_gui_toaster_addTemplateToast;
					sleep 1;
